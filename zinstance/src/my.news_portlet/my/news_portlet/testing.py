...
import my.news_portlet

class NewsPortlets(PloneSandboxLayer):
    ...
    def setUpPloneSite(self, portal):
        applyProfile(portal, 'my.news_portlet:default')
...
FIXTURE = NewsPortlets()
INTEGRATION_TESTING = IntegrationTesting(
    bases=(FIXTURE,),
    name="NewsPortlets:Integration",
)
